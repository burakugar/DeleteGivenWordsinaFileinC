...
typedef enum cell_type{cell_wall,cell_free,cell_target,cell_p1,cell_p2}cell_type;
typedef enum move_type{move_up,move_down,move_left,move_right}move_type;
